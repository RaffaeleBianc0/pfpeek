...
- The output partially adapts to the console window size. Tall is better; fullscreen is even better. Try also with different font sizes (usually [Ctrl]+mousewheel works).
